...
const corsOptions: CorsOptions = {
  origin: ['https://strive-frontend-gejy.onrender.com', 'http://www.strive-management.com'], // replace with your frontend address https://strive-frontend-gejy.onrender.com
  credentials: true,
};
